...
dreamy_color = '#4E79A7'
duck_color = '#E15759'
dreamy_label = 'Doc Dreamy'
duck_label = 'Doc Duck'

dreamy_df = patients_df[patients_df['doctor_name'] == dreamy_label]
duck_df = patients_df[patients_df['doctor_name'] == duck_label]
...
ax.axhline(mean_dreamy, color=dreamy_color, linestyle='--', linewidth=1.5, alpha=0.85, zorder=2)
ax.axhline(mean_duck, color=duck_color, linestyle='--', linewidth=1.5, alpha=0.85, zorder=2)
...
ax.set_title('Post-Surgical Symptom Score by Patient and Doctor', fontsize=13, fontweight='semibold')
...
dreamy_df = patients_randomized_df[patients_randomized_df['doctor_name'] == dreamy_label]
duck_df = patients_randomized_df[patients_randomized_df['doctor_name'] == duck_label]
...
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=11)
ax.set_title(
    'Post-Surgical Symptom Score by Patient and Doctor (Randomized Assignment)',
    fontsize=13,
    fontweight='semibold',
)
ax.grid(True, linestyle=':', alpha=0.45)
...
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=11)
ax.set_title('Post-Surgical Symptom Score by Patient Severity', fontsize=13, fontweight='semibold')
ax.grid(True, linestyle=':', alpha=0.45)
ax.set_axisbelow(True)
ax.tick_params(axis='both', labelsize=10)
ax.legend(loc='upper left', framealpha=0.95, fontsize=10)
